...
const MODULES: ModuleCheck[] = [
  ...
  },
  {
    ...
    expectedExports: ['MailProvider', 'SmtpMailProvider', 'MemoryMailProvider', 'createMailPlugin'],
    hasPeerDeps: true,
  ...
  {
    name: 'authz',
    importPath: './dist/authz/index.js',
    expectedExports: [
      'satisfiesAccess',
  ...
  {
    name: 'webafx-authz',
    importPath: './dist/webafx-authz/index.js',
    expectedExports: [
      'requireAccess',
      'requireScopes',
      'decodeJwtClaims',
  ...
  {
    name: 'api-client',
    importPath: './dist/api-client/index.js',
    expectedExports: ['createApiClient', 'ApiError', 'ApiTransportError', 'FetchAdapter'],
    hasPeerDeps: false,
  },
];
...
async function verifyModule(mod: ModuleCheck, baseDir: string): Promise<CheckResult> {
  ...
  try {
    ...
    const exportCount = Object.keys(exports).filter(
