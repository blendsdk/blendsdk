...
### Added
- Generated versionless AI training and skill references by dropping version metadata from templates.

### Changed
- Regenerated all AI training sources with DeepSeek to improve assembly of the agent skill.
- Sanitized the injected package.json context by removing reference header injection.

### Removed
- Removed the version metadata line from 11 AI training templates and the {{version}} prompt variable.


## [5.56.0] - 2026-09-15

## Added
- Generate versionless AI training and skill references in templates and remove version metadata.

## Changed
- Sanitize injected package.json context and remove reference header injection from various files.
- Assemble agent skill from regenerated sources, including migration of retired MCP guides and patterns.

## Fixed
- Updated multiple AI training documentation files to reflect changes in content and structure.


## [5.55.0] - 2026-09-14

## Added
- Assembled agent skill from regenerated sources comprising 176 ai-training sources.

## Changed
- Migrated and updated retired MCP hand-written guides and patterns to new skill templates and architecture references.
- Updated documentation files across ai-training sections including core concepts, usage, patterns, and troubleshooting.
