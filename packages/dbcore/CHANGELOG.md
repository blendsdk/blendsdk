...
## Added
- Generate versionless AI training and skill references, removing version metadata from templates.

## Changed
- Regenerate all AI training sources with DeepSeek, migrating retired MCP guides and patterns.

## Fixed
- Conform generated examples to the public surface, ensuring imports use only public symbols.


## [5.56.0] - 2026-09-15

- Added: Generate versionless AI-training and skill references, removing version metadata from 11 templates.
- Fixed: Conform generated examples to public surface, ensuring they import only public symbols.
- Added: Assemble agent skill from regenerated sources, migrating retired MCP guides and enhancing AI-training references.


## [5.55.0] - 2026-09-14

Changed:
- Conformed generated examples to the public surface for clearer imports and rebuilt the generated skill tree. 
- Regenerated all AI training sources, enhancing the agent skill assembly process with updated content and structures.

Fixed:
- Ensured examples import only public symbols after regenerating codegen and related components.

Added:
- Assembled agent skill from regenerated sources, including 176 AI training examples and documentation for various templates and guides.
