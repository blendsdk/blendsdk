...
### Changed
- Regenerate all AI-training sources with DeepSeek and assemble the agent skill from new templates.

### Fixed
- Sanitize the injected package.json context by removing unnecessary reference headers and injections.
...
Changed:
- Regenerated all 176 AI training sources with DeepSeek and updated associated documentation.
- Sanitized the injected package.json context by removing the reference header injection.

Removed:
- Dropped the {{version}} prompt variable from AI training templates.


## [5.55.0] - 2026-09-14

### Added
- Assembled agent skill from regenerated sources using DeepSeek, incorporating 176 AI-training sources.

### Changed
- Migrated and updated retired MCP hand-written guides, patterns, and templates for better integration.

### Fixed
- Improved documentation across multiple AI-training resources for clarity and consistency.
