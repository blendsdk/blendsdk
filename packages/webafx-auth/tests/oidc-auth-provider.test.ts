...
describe("OidcAuthProvider", () => {
    ...
    describe("authenticate()", () => {
        ...
        it("should propagate an error thrown by an async resolveUser", async () => {
            ...
            await expect(
                provider.authenticate(createBearerRequest("token"))
            ).rejects.toThrow("resolver unavailable");
        });

        it("should treat a synchronous mapper error as a failed authentication", async () => {
