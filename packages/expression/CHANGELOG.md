...
Changed:
- Regenerate and assemble AI training sources with DeepSeek, migrating retired hand-written guides and patterns.
- Conform generated examples to public surface, ensuring only public symbols are imported.

Fixed:
- Ensure all generated examples accurately reflect the public surface of the package.
...
- Conformed generated examples to use only public symbols after regenerating codegen, dbcore, expression, react, and webafx-cache.

## Fixed
- Regenerated all 176 AI-training sources and assembled agent skill, migrating retired MCP hand-written guides and patterns.


## [5.55.0] - 2026-09-14

Added:
- Assembled agent skill from regenerated sources with DeepSeek, covering 176 ai-training sources.

Changed:
- Regenerated and updated various documentation files to conform to public API surface and improve clarity.

Fixed:
- Ensured generated examples import only public symbols and rebuilt the generated skill tree accordingly.
