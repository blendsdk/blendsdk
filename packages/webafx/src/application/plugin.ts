...
export class PluginRegistry {
  ...
  constructor() {
    // Null-prototyped so a name like "__proto__" is stored as an ordinary
    // key instead of hitting the prototype setter.
    this.registry = Object.create(null) as Record<string, PluginDefinition>;
    this._shutdown = [];
    this._health = [];
    this._terminals = [];
  ...
  register(def: PluginDefinition) {
    if (Object.prototype.hasOwnProperty.call(this.registry, def.name)) {
