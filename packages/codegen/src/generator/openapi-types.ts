...
export interface OpenAPISchema {
  /**
   * The data type (string, number, integer, boolean, array, object), or an
   * array of types. OpenAPI 3.1 uses a type array to express nullability, for
   * example `['string', 'null']`.
   */
  type?: string | string[];
  ...
  /** A single allowed constant value (JSON Schema 2020-12) */
  const?: unknown;

  /** Schema applied to the property names of an object */
  propertyNames?: OpenAPISchema;

  /** Tuple items for array schemas (JSON Schema 2020-12) */
  prefixItems?: OpenAPISchema[];

  /** Example values for this schema */
  examples?: unknown[];

  /** Reusable definitions referenced through `#/$defs/...` before hoisting */
...
export interface OpenAPIOperation {
  ...
  deprecated?: boolean;
  /**
   * How a generated client reads a successful response body: `'data'` unwraps
   * the top-level `data` property, `'body'` returns the whole body.
   */
  'x-blend-envelope'?: 'data' | 'body';
}
