...
## Changed  
- Regenerate all AI-training sources with DeepSeek and assemble the agent skill.

## Fixed  
- Sanitize injected package.json context and remove reference header injection plus miscellaneous errors.


## [5.56.0] - 2026-09-15

### Added
- Generate versionless AI training and skill references by dropping version metadata from 11 templates and the {{version}} prompt variable.

### Changed
- Sanitize injected package.json context by removing reference header injection and unnecessary details.
- Assemble agent skill from regenerated sources and migrate retired MCP guides to updated formats.

### Deprecated
- Removed version metadata prompts from AI training templates.


## [5.55.0] - 2026-09-14

## Added
- Assembled agent skill from regenerated sources with DeepSeek, encompassing all 176 ai-training sources.

## Changed
- Migrated retired MCP hand-written guides and patterns to the new documentation structure. 
- Updated several ai-training documentation files including core concepts, usage, and best practices.
