...
### Added
- Generate versionless ai-training and skill references, dropping version metadata from templates.

### Changed
- Conform generated examples to the public surface, ensuring imports only use public symbols.

### Fixed
- Sanitize and clean injected package.json context to enhance reference clarity.


## [5.56.0] - 2026-09-15

## Added
- Generate versionless AI-training and skill references by dropping version metadata from templates and references.

## Changed
- Conform generated examples to the public surface, ensuring all imports are only public symbols.

## Fixed
- Regenerate all AI-training sources with DeepSeek, migrating and assembling the agent skill from updated materials.


## [5.55.0] - 2026-09-14

### Fixed
- Conformed generated examples to the public surface by ensuring they import only public symbols.

### Added
- Assembled agent skill from regenerated sources for improved AI training capabilities.

### Changed
- Updated all AI training documents within the webafx-cache package, enhancing clarity and organization.
