...
### Changed
- Regenerate all AI training sources to assemble the agent skill with updated methodologies and templates.

### Deprecated
- Drop the {{version}} prompt variable from AI training templates.


## [5.56.0] - 2026-09-15

## Changed
- Dropped version metadata from 11 ai-training templates and removed the {{version}} prompt variable.
- Sanitized the injected package.json context by removing the reference header injection.

## Added
- Generated versionless ai-training and skill references.

## Fixed
- Assembled agent skill from regenerated sources with 176 ai-training sources using DeepSeek.


## [5.55.0] - 2026-09-14

Added:
- Assembled the agent skill from regenerated sources using DeepSeek.

Changed:
- Migrated and updated MCP hand-written guides and templates to new structure.
- Revised content in multiple ai-training documentation files for clarity and consistency.
